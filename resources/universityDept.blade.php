                ...
                <div class="row">
                                          ...
                                          <div class="accordions" id="accordion" role="tablist" aria-multiselectable="true">
                                              ...
                                              <div class="panel single-accordion align-items-center">
                                                <div class="search-area">
                                                    <form method="post">
                                                        <input type="search" id="myInput" onkeyup="myFunction()" name="search" placeholder="Search Departments">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="course-sidebar">
                            <!-- Buy Course -->
                            <a href="http://www.nust.edu.pk" class="btn clever-btn mb-30 w-100"><i class="fa fa-arrow-left"></i> University Page</a>
