                ...
                <div class="row">
                                              ...
                                              <ul class="curriculum-list3">
                                                <ul>
                                                  ...
                                                  <li>
                                                    ...
                                                    <h6 style="color:;">Semester System</h6>
                                                  </li>
                                                  <li>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="course-sidebar">
                            <!-- Buy Course -->
                            <a href="http://www.nust.edu.pk" class="btn clever-btn mb-30 w-100"><i class="fa fa-arrow-left"></i> Department Page</a>
